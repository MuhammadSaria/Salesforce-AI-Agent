...
export function buildOrgContext(selection, job) {
  return {
    ...
    recordDeletionPermission: selection.org.recordDeletionPermission,
    ...
    maximumDeleteOperations: selection.org.maximumDeleteOperations,
...
function normalizeOrg(org) {
  ...
  return {
    ...
    recordDeletionPermission: String(org.recordDeletionPermission || 'blocked'),
    ...
    maximumDeleteOperations: Math.max(1, Math.min(Number(org.maximumDeleteOperations || 1), 5)),
